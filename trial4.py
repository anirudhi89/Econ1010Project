...
countries = {'UK': 413, 'France': 421, 'Germany': 453, 'Mexico': 200, 'Japan': 501, 'China': 500}
...
for country, migplac5 in countries.items():
    ...
    avg_wage = country_data[country_data['FWAGE1'] != 0]['FWAGE1'].mean()
...
for country, avg_wage in avg_immigrant_wages.items():
    pd.Series(avg_wage).to_csv(f'r4/avg_{country}_wage.csv', header=['Average_Wage'])
